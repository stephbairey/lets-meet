...
/**
 * Client booking reschedule confirmation email template.
 *
 * Available variables:
 * @var array  $args     Booking data (service_name, date_display, time_display, duration, client_name, cancel_token, etc.)
 * @var array  $settings Plugin settings.
 *
 * This template can be overridden by copying it to:
 *   your-theme/lets-meet/emails/reschedule-client.php
 */
?>
<!DOCTYPE html>
<html lang="en">
					...
					<tr>
						<td style="padding: 32px;">
							...
							<p style="margin: 0 0 24px; font-size: 15px; color: #555555; line-height: 1.6;">
								<?php esc_html_e( 'Your booking has been rescheduled. Here are your updated details:', 'lets-meet' ); ?>
							</p>
							...
							<p style="margin: 24px 0 0; text-align: center;">
								<a href="<?php echo esc_url( $reschedule_url ); ?>"
								   style="display: inline-block; background-color: #0073aa; color: #ffffff; text-decoration: none; padding: 10px 24px; border-radius: 4px; font-size: 14px; font-weight: 600; margin-right: 8px;">
									<?php esc_html_e( 'Reschedule Again', 'lets-meet' ); ?>
								</a>
